...
$(document).ready(function () {
    ...
    let colours = ["AliceBlue","Aqua","Aquamarine","Azure","Blue","CadetBlue","CornflowerBlue","Cyan","DarkBlue","DarkCyan","DarkTurquoise","DeepSkyBlue","DimGray","DimGrey","DodgerBlue","GhostWhite","Gray","Grey","LightBlue","LightCyan","LightGray","LightGrey","LightSkyBlue","LightSlateGrey","LightSteelBlue","MediumAquaMarine","MediumBlue","MediumTurquoise","MidnightBlue","Navy","PaleTurquoise","PowderBlue","RoyalBlue","SkyBlue","SlateBlue","SlateGray","SlateGrey","Snow","SteelBlue","Teal","Turquoise"];
    var squares = [];
